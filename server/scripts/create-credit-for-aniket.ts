/**
 * Script to create onramp credit for aniket@opika.co with service fee discounts
 */
...
async function createCredit() {
  ...
  try {
    ...
    // Create onramp credit with service fee discounts using direct SQL
    ...
    console.log(`   Card adds remaining: ${credit.card_adds_allowed - credit.card_adds_free_used}`);
